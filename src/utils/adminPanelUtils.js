...
import Permissions from '../admin/components/permissions';
...
const AdminPanel = 
    {
        admin: [
            ...
            { title: 'Permissions', component: <Permissions />, icon: 'fa fa-bell-slash fa-1x fa-fw' },
            // { title: 'Settings', component: <Users />, icon: 'fa fa-cogs fa-1x fa-fw' },
        ],
        agent: [
            { title: 'Users', component: <Users />, icon: 'fa fa-users fa-1x fa-fw' },
            { title: 'Banks', component: <Banks />, icon: 'fa fa-university fa-1x fa-fw' },
            { title: 'Stats', component: <Stats />, icon: 'fa fa-area-chart fa-1x fa-fw' },
            // { title: 'Settings', component: <Settings />, icon: 'fa fa-cogs fa-1x fa-fw' },
