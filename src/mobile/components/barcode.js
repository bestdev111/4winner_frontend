...
function BarcodeContainer(props){
  return (
    <div className='barCodePan'>
      <Barcode className='barCode' value={props.barCodeJsonString} format="CODE128" displayValue={true} fontOptions="" font="monospace" textAlign="center" textPosition="top" textMargin={2} fontSize={20} background= "#ffffff" lineColor="#000000" margin={10} marginTop={undefined} marginBottom={undefined} marginLeft={undefined} marginRight={undefined}/>
